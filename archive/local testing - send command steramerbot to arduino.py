...
SERIAL_PORT = 'COM7'  # Replace with the correct COM port for the FTDI
...
def send_command_to_arduino(frequency, color):
    try:
        ...
        with serial.Serial(SERIAL_PORT, BAUD_RATE, timeout=10) as ser:
            ...
            print(f"1 ---- Opened serial connection on {SERIAL_PORT} at {BAUD_RATE} baud")
            ...
            print(f"2 ---- Sent to Arduino: {message}")
